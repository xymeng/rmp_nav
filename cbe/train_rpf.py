...
if __name__ == '__main__':
    ...
    # Since RPF doesn't care how many frames we may as well always use max number of frames.
    gflags.DEFINE_integer('n_frame_min', 64, '')
    gflags.DEFINE_integer('n_frame_max', 64, '')
    gflags.DEFINE_integer('frame_interval', 2, '')
    gflags.DEFINE_boolean('rand_frame_interval', False, '')
    gflags.DEFINE_boolean('normalize_wp', True, '')
    ...
    gflags.DEFINE_boolean('dagger', False, 'Enable dagger training.')
    ...
    train_funcs = {
        'default': train_fixture.train_rpf,
        'feature_map': train_fixture.train_rpf,
    }
