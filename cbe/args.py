...
gflags.DEFINE_integer('log_interval', 100, 'Print log message every this number of iterations.')
gflags.DEFINE_integer('save_interval', 1, 'Save weights every this number of epochs.')
